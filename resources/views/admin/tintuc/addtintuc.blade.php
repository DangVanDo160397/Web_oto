        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
               @if(count($errors)>0)
                ...
                @endif
                <form action="admin/tintuc/potsttintuc" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-default">Add Tin Tuc</button>
